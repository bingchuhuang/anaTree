...
void makeAnaTree(const Int_t runnumber=15094070,
	...
	picoMaker->setProdMode(prodMod); // 0-mb, 1-central, 2-ht, 4-only e or mu  // 1,2 are not used in run14 StPicoDstMaker.
